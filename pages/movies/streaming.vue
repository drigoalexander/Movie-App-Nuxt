<template>
  ...
  <h1 class="text-white text-5xl">
   ...
   <h1 @click="redPage" class="text-white font-bold text-3xl"> NUXTFLIX</h1>
      ...
      <div class="flex items-center justify-center gambarfilm w-full h-[40rem] pb-20 relative">
          <div class="z-0  w-full h-full  bg-cover bg-no-repeat relative gambarfilm2" >
             <div class="w-full h-full absolute z-10 bg-gradient-to-r from-black to-transparent top-0 left-0">
                 <div class="absolute z-20 w-full h-full top-0 left-0">
                     <div class="relative flex flex-col justify-start items-start px-20 py-20 gap-10 text-white h-full">
                         ...
                         <h1 class="text-white text-4xl font-bold w-1/2">AVENGERS : ENDGAME</h1>
                         <p class="text-white text-lg font-medium -mt-6">Marvel Cinematic Universe</p>
                         <p class="text-white text-xl font-bold w-1/2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Qui, nam. Voluptate earum tempore asperiores quasi ut amet saepe alias laboriosam!</p>
                         <button class="cursor-pointer hover:scale-110 duration-300 ease-in-out rounded-full font-bold w-auto px-10 py-2 bg-gradient-to-r from-[#00AFD2] via-[#55C0AB] to-[#7BC79A]">
Play
                         </button>
                     </div>
                 </div>
